...
def test_migrated_runtime_resources_exist_and_parse():
    expected = (
        ...
        "ackermann/launch/ackermann_georeference_validation.launch.py",
        ...
        "localization/navsat/include/agribot_hardware_bringup/georeference_test_conversions.hpp",
        ...
        "config/visual_initialization.yaml",
