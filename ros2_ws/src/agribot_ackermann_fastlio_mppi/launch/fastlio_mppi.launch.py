...
def generate_launch_description():
    package_share = get_package_share_directory("agribot_ackermann_fastlio_mppi")
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "fastlio_config",
                default_value=os.path.join(package_share, "config", "fast_lio_c16.yaml"),
            ),
            DeclareLaunchArgument(
                "bridge_config",
                default_value=os.path.join(package_share, "config", "fastlio_bridge.yaml"),
            ),
            ...
            Node(
                ...
                output="screen",
                parameters=[LaunchConfiguration("fastlio_config"), {"use_sim_time": use_sim_time}],
            ),
            Node(
                ...
                output="screen",
                parameters=[LaunchConfiguration("bridge_config"), {"use_sim_time": use_sim_time}],
            ),
            Node(
                package="tf2_ros",
                ...
                arguments=[
                    ...
                    "--z", LaunchConfiguration("map_to_odom_z"),
                    "--roll", LaunchConfiguration("map_to_odom_roll"),
                    "--pitch", LaunchConfiguration("map_to_odom_pitch"),
