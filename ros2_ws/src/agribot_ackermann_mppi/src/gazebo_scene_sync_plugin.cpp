...
namespace gazebo
{
class AgribotGazeboSceneSync : public WorldPlugin
{
public:
  void Load(physics::WorldPtr world, sdf::ElementPtr) override
  {
    ...
    update_connection_ = event::Events::ConnectWorldUpdateBegin(
      std::bind(&AgribotGazeboSceneSync::OnUpdate, this, std::placeholders::_1));
  }
...
GZ_REGISTER_WORLD_PLUGIN(AgribotGazeboSceneSync)
}  // namespace gazebo
